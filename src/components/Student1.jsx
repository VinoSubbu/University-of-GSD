...
import SAM from "../assets/SamPro.jpg";
  ...
  return (
    <div className="student-container">
      ...
      <div className="student-profile">
        <img src={SAM} alt="profile-SAM" className="student-image" />
      </div>

    <div className="stu-info-outer">
    <div className="student-info">
        <h2 className="stu-name" >Samyuktha UmaDevi <EditIcon className="edit-name" style={{cursor:'pointer'}} /></h2>
        <div className="info">
        ...
        <div className="info">
          ...
          <p className="val">Female</p>
        </div>
        <div className="info">
          <label htmlFor="address">Address : </label>
          <p className="val">Trichirapalli</p>
        </div>
        <div className="info">
          <label htmlFor="email">Email : </label>
          <p className="val">sam@gmail.com</p>
        </div>
        <div className="info">
